...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME","Pari_zmsic_bot")

# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "5565653587").split())
...
# Images
START_IMG_URL = getenv("START_IMG_URL", "https://te.legra.ph/file/eb3506dfe176746f136f5.jpg")
