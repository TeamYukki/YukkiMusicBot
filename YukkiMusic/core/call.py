...
class Call(PyTgCalls):
    ...
    async def join_call(
        ...
        try:
            ...
            raise AssistantErr(
                "**خطأ بل سيرفر مال تلي **\n\nالتلي جاي يجواجه مشاكل بل خادم الداخلي عبد المحاوله بعدين .\n\n اذا استمرت هل مشكله فب الضهور كل ساعه فه يجب اغلاق  المكالمه وشغلها من جديد."
            )
    ...
    async def start(self):
        LOGGER(__name__).info("بدء عميل PyTgCalls \n")
        if config.STRING1:
